...
#ifndef MICRO_OS_PLUS_ARCHITECTURE_CORTEXA_STARTUP_HOOKS_H_
#define MICRO_OS_PLUS_ARCHITECTURE_CORTEXA_STARTUP_HOOKS_H_
...
#endif // MICRO_OS_PLUS_ARCHITECTURE_CORTEXA_STARTUP_HOOKS_H_
