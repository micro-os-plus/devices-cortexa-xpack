...
- add a new file to `_posts/devices-cortexa/releases`
- name the file like `2020-12-19-devices-cortexa-v0-1-0-released.md`
- name the post like: **µOS++ devices-cortexa v3.0.0 released**
- update the `date:` field with the current date
- update the GitHub Actions URLs using the actual test pages

If any, refer to closed
[issues](https://github.com/micro-os-plus/devices-cortexa-xpack/issues/)
as:
...
- `npm dist-tag add @micro-os-plus/devices-cortexa@3.0.0 latest`
- `npm dist-tag ls @micro-os-plus/devices-cortexa`
...
- paste the release name like **µOS++ devices-cortexa v3.0.0 released**
